...
import com.example.bankline_android.databinding.BankStatmentItemBinding
...
class BankStatmentAdapter(private val dataSet: List<Movimentacao>) : RecyclerView.Adapter<BankStatmentAdapter.ViewHolder>() {
    ...
    class ViewHolder(private val binding: BankStatmentItemBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = BankStatmentItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
